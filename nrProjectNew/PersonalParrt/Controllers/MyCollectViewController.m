...
#import "CDonateViewController.h"


@interface MyCollectViewController ()<MXSegmentedPagerDelegate, MXSegmentedPagerDataSource>
{
    CArticleViewController *vc1;
    CDonateViewController *vc2;
    CWishViewController *vc3;
    CSubjectViewController *vc4;
}
...
- (void)viewDidLoad {
    ...
    [self.customNavBar setTitle:@"我的收藏"];


    vc1 = [[CArticleViewController alloc] init];
    vc2 = [[CDonateViewController alloc] init];
    vc3 = [[CWishViewController alloc] init];
    vc4 = [[CSubjectViewController alloc] init];
...
- (NSString *)segmentedPager:(MXSegmentedPager *)segmentedPager titleForSectionAtIndex:(NSInteger)index {
    ...
    return [@[@"文章", @"捐赠", @"心愿", @"专题"] objectAtIndex:index];
}

- (UIView *)segmentedPager:(MXSegmentedPager *)segmentedPager viewForPageAtIndex:(NSInteger)index {
    
    return @[vc1.view, vc2.view, vc3.view, vc4.view][index];
}
