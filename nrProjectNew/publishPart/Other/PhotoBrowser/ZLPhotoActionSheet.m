...
//    nav.previousStatusBarStyle = self.previousStatusBarStyle;
    [nav.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName: kUIColorFromRGB(0x000000)}];
    [nav.navigationBar setBackgroundImage:[self imageWithColor:kRGB(255, 255, 255)] forBarMetrics:UIBarMetricsDefault];
//    [nav.navigationBar setTintColor:[UIColor redColor]];
//    nav.navigationBar.barStyle = UIBarStyleBlack;
    [nav.navigationBar setBarTintColor:kUIColorFromRGB(0x000000)];
//     [nav.navigationBar setTintColor:[UIColor redColor]];
//    [nav.navigationItem.rightBarButtonItem setTintColor:[UIColor redColor]];
