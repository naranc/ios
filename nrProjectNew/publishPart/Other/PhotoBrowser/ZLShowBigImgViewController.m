...
//    UIImage *navBackImg = [UIImage imageNamed:kZLPhotoBrowserSrcName(@"navBackBtn.png")]?:[UIImage imageNamed:kZLPhotoBrowserFrameworkSrcName(@"navBackBtn.png")];
    UIImage *navBackImg = [UIImage imageNamed:@"back_image"];
    //浏览返回按钮
...
- (void)initBottomView
{
    ...
    _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 44 - top, kViewWidth, 44)];
    ...
    [_btnOriginalPhoto setTitleColor:MainColor forState: UIControlStateNormal];
    [_btnOriginalPhoto setTitleColor:MainColor forState: UIControlStateSelected];
    ...
    self.labPhotosBytes.textColor = MainColor;
    ...
    [_btnDone setBackgroundColor:MainColor];
...
- (void)showNavBarAndBottomView
{
    ...
    frame.origin.y -= frame.size.height + top;
