...
- (void)resetBottomBtnsStatus
{
    if (self.arraySelectPhotos.count > 0) {
        ...
        [self.btnOriginalPhoto setTitleColor:MainColor forState:UIControlStateNormal];
        [self.btnPreView setTitleColor:MainColor forState:UIControlStateNormal];
        self.btnDone.backgroundColor = MainColor;
...
- (void)initNavBtn
{
    ...
    [btn setTitleColor:kUIColorFromRGB(0xBBBBBB) forState:UIControlStateNormal];
