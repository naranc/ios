//
//  SelectAnonymityTableViewCell.m
//  nrProjectNew
//
...
#import "SelectAnonymityTableViewCell.h"

@interface SelectAnonymityTableViewCell ()
...
@implementation SelectAnonymityTableViewCell
...
- (UIButton *)noButton
{
    if (!_noButton) {
        ...
        _noButton.frame = CGRectMake(15, _titleLabel.bottom + 11, 39, 24);
...
- (UIButton *)yesButton
{
    if (!_yesButton) {
        ...
        _yesButton.frame = CGRectMake(_noButton.right + 24, _titleLabel.bottom + 11, 39, 24);
