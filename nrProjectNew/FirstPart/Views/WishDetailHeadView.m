...
@implementation WishDetailHeadView
...
- (id)initWithFrame:(CGRect)frame morePic:(BOOL)morePic model:(WishModel *)wishModel
{
    if ([super initWithFrame:frame]) {
        ...
        self.bgView.frame = CGRectMake(12, 0, SCREEN_WIDTH - 24, 162 + rect.size.height + (SCREEN_WIDTH - 40)/3);
        ...
        _jgView.frame = CGRectMake(3, _contentLabel.bottom + 8, SCREEN_WIDTH - 30, (SCREEN_WIDTH - 40)/3);
