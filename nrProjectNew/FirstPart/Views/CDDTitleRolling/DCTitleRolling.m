...
- (void)setUpRollingLeft
{
    ...
    self.leftImageView.frame = CGRectMake(25, RollingViewHeight * 0.1, RollingViewHeight * 1.5, RollingViewHeight * 0.8);
...
- (void)setUpRollingRight
{
    ...
    btnLine.frame = CGRectMake(RollingViewWidth * 0.82, RollingViewHeight * 0.25, 0.5, RollingViewHeight * 0.5);
